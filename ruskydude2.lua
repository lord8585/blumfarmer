...
MainFrame.Size = UDim2.new(0, 185, 0, 450)
...
SmoothBar.Position = UDim2.new(0.05, 0, 0.76, 0)
...
makeBtn(UnloadBtn, "UNLOAD", UDim2.new(0.05, 0, 0.84, 0), Color3.fromRGB(45, 45, 50))
